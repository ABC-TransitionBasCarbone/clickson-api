...
(1, 1, 1, 'Energy', 'The energy category focuses on the school''s energy consumption over a school year. Initially, data on electricity and heating consumption will be collected. For a complete approach, consumptions linked to chemistry laboratories will also be added.'),
(2, 1, 2, 'Énergie', 'La catégorie énergie se concentre sur la consommation d''énergie de l''école au cours d''une année scolaire. Initialement, les données sur la consommation d''électricité et de chauffage seront collectées. Pour une approche complète, les consommations liées aux laboratoires de chimie seront également ajoutées.'),
(3, 1, 3, 'Energía', 'La categoría de energía se centra en el consumo de energía de la escuela durante un año escolar. Inicialmente, se recopilarán datos sobre el consumo de electricidad y calefacción. Para un enfoque completo, también se añadirán los consumos vinculados a los laboratorios de química.'),
(4, 1, 4, 'Energia', 'La categoria energia si concentra sul consumo di energia della scuola durante l''anno scolastico. Inizialmente verranno raccolti i dati sul consumo di elettricità e riscaldamento. Per un approccio completo, verranno aggiunti anche i consumi legati ai laboratori di chimica.'),
(5, 1, 5, 'Ενέργεια', 'Η κατηγορία ενέργειας επικεντρώνεται στην κατανάλωση ενέργειας του σχολείου κατά τη διάρκεια ενός σχολικού έτους. Αρχικά, θα συλλεχθούν δεδομένα για την κατανάλωση ηλεκτρικής ενέργειας και θέρμανσης. Για μια ολοκληρωμένη προσέγγιση, θα προστεθούν και οι καταναλώσεις που συνδέονται με τα χημικά εργαστήρια.'),
(6, 1, 6, 'Energija', 'Kategorija energije fokusira se na potrošnju energije škole tijekom školske godine. U početku će se prikupljati podaci o potrošnji električne energije i grijanja. Za cjelovit pristup dodati će se i potrošnja povezana s kemijskim laboratorijima.'),
(7, 1, 7, 'Energia', 'Az energia kategória az iskola energiafogyasztására összpontosít egy tanév során. Kezdetben az elektromos áram és a fűtés fogyasztási adatait gyűjtik. Teljesebb megközelítéshez hozzáadódnak a kémiai laboratóriumokhoz kapcsolódó fogyasztások is.'),
...
(14, 2, 6, 'Usluga Prehrane', 'U kategoriji usluga prehrane, učenici moraju izračunati emisije povezane s posluživanjem obroka. U nekim će se školama također prikupljati podaci o hrani koja se prodaje u kantinama i automatima.'),
(15, 2, 7, 'Élelmiszer Szolgáltatás', 'Az élelmiszer-szolgáltatás kategóriában a diákoknak ki kell számolniuk a felszolgált ételekkel kapcsolatos kibocsátásokat. Bizonyos iskolákban az étkezde és az automatákban értékesített ételek adatai is gyűjtésre kerülnek.'),
...
(22, 3, 6, 'Putovanje', 'Kategorija putovanja usredotočuje se na emisije povezane s putovanjem učenika, nastavnika i nenastavnog osoblja od kuće do škole, kao i na školske izlete ako ih bude.'),
(23, 3, 7, 'Utazás', 'Az utazási kategória a diákok, tanárok és nem tanári személyzet otthonról az intézménybe történő utazásával, valamint az esetlegesen megrendezett iskolai kirándulásokkal kapcsolatos kibocsátásokra összpontosít.'),
...
(30, 4, 6, 'Zalihe', 'U kategoriji zaliha unose se svi materijali kupljeni za školsku godinu. To su uglavnom potrošni materijali ili proizvodi kratkog vijeka koji će se koristiti tijekom godine i morat će se ponovno kupiti sljedeće godine.'),
(31, 4, 7, 'Kellékek', 'A kellékek kategóriában az összes, az iskolai évre vásárolt anyag kerül bevezetésre. Ezek többnyire fogyóeszközök vagy rövid élettartamú termékek, amelyeket az év során használnak, és a következő évben újra meg kell vásárolni.'),
