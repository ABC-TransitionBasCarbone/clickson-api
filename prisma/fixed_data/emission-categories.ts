    ...
    emissionSubCategories: [
      {
        ...
        emissionFactors: [
          { label: 'Fioul de chauffage', type: 'Combustible', unit: 'kgCO2e/kWh chauffage net', value: 0.324, uncertainty: 0 },
          { label: 'Fioul lourd', type: 'Combustible', unit: 'kgCO2e/kWh chauffage net', value: 0.324, uncertainty: 0 },
          { label: 'Gaz naturel', type: 'Combustible', unit: 'kgCO2e/kWh chauffage brut', value: 0.214, uncertainty: 0 },
          {
            label: 'Granulés de bois (8% d\'humidité)',
            type: 'Combustible',
            unit: 'kgCO2e/kWh chauffage net',
            value: 0.0304,
            uncertainty: 4,
          },
        ],
      },
      {
        ...
        emissionFactors: [
          { label: 'Janvier', type: 'Électricité', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'Février', type: 'Électricité', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'Mars', type: 'Électricité', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'Avril', type: 'Électricité', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'Mai', type: 'Électricité', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'Juin', type: 'Électricité', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'Juillet', type: 'Électricité', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'Août', type: 'Électricité', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'Septembre', type: 'Électricité', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'Octobre', type: 'Électricité', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'Novembre', type: 'Électricité', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'Décembre', type: 'Électricité', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
        ],
      },
      {
        id: 3,
        ...
        emissionFactors: [
          { label: 'R134a', type: 'Gaz réfrigérant', unit: 'kgCO2e/kg', value: 1300, uncertainty: 3 },
          {
          ...
          { label: 'R32', type: 'Gaz réfrigérant', unit: 'kgCO2e/kg', value: 675, uncertainty: 3 },
          {
          ...
          { label: 'R407c', type: 'Gaz réfrigérant', unit: 'kgCO2e/kg', value: 1624, uncertainty: 3 },
          { label: 'R410a', type: 'Gaz réfrigérant', unit: 'kgCO2e/kg', value: 2088, uncertainty: 3 },
          { label: 'R452a', type: 'Gaz réfrigérant', unit: 'kgCO2e/kg', value: 2140, uncertainty: 3 },
          { label: 'R513a', type: 'Gaz réfrigérant', unit: 'kgCO2e/kg', value: 631, uncertainty: 5 },
          { label: 'R744 - CO2', type: 'Gaz réfrigérant', unit: 'kgCO2e/kg', value: 1, uncertainty: 3 },
          { label: 'CO2', type: 'Gaz à effet de serre principal', unit: 'kgCO2e/kg', value: 1, uncertainty: 0 },
          { label: 'CH4 fossile', type: 'Gaz à effet de serre principal', unit: 'kgCO2e/kg', value: 30, uncertainty: 0 },
          { label: 'CH4 biogénique', type: 'Gaz à effet de serre principal', unit: 'kgCO2e/kg', value: 28, uncertainty: 0 },
          { label: 'N2O', type: 'Gaz à effet de serre principal', unit: 'kgCO2e/kg', value: 265, uncertainty: 0 },
          { label: 'SF6', type: 'Gaz à effet de serre principal', unit: 'kgCO2e/kg', value: 23500, uncertainty: 0 },
          { label: 'NF3', type: 'Gaz à effet de serre principal', unit: 'kgCO2e/kg', value: 16100, uncertainty: 0 },
        ],
      },
    ],
  },
    ...
    emissionSubCategories: [
      {
        ...
        emissionFactors: [
          { label: 'Repas typique', type: 'Repas', unit: 'kgCO2e/repas', value: 2.25, uncertainty: 4 },
          { label: 'Repas végétarien', type: 'Repas', unit: 'kgCO2e/repas', value: 0.45, uncertainty: 4 },
          { label: 'Plat principal de viande rouge', type: 'Repas', unit: 'kgCO2e/repas', value: 7.26, uncertainty: 4 },
          { label: 'Plat principal de viande blanche', type: 'Repas', unit: 'kgCO2e/repas', value: 1.58, uncertainty: 4 },
        ],
      },
      {
        id: 5,
      ...
      },
      {
        ...
        emissionFactors: [
          ...
          { label: 'Véhicule utilitaire léger', type: 'Transport routier', unit: 'kgCO2e/tonne.km', value: 1.2, uncertainty: 4 },
          {
    ...
    emissionSubCategories: [
      ...
      },
      {
        ...
        emissionFactors: [
          ...
          { label: 'Voiture personnelle – diesel', type: 'Transport', unit: 'kgCO2e/km', value: 0.251, uncertainty: 2 },
          {
            label: 'Bus de ville : agglomérations population 100 000 – 250 000',
            type: 'Transport',
            unit: 'kgCO2e/passager.km',
          ...
          { label: 'Métro', type: 'Transport', unit: 'kgCO2e/passager.km', value: 0.006, uncertainty: 2 },
          {
          ...
          { label: 'Tramway', type: 'Transport', unit: 'kgCO2e/passager.km', value: 0.006, uncertainty: 2 },
          {
          ...
          { label: 'Avion', type: 'Transport', unit: 'kgCO2e/passager.km', value: 0.187, uncertainty: 5 },
        ],
      },
      {
        id: 9,
    ...
    emissionSubCategories: [
      {
        ...
        emissionFactors: [
          ...
          { label: 'Chaise (bois)', type: 'Équipement de bureau', unit: 'kgCO2e/unité', value: 18.6, uncertainty: 1 },
          { label: 'Livre', type: 'Équipement de bureau', unit: 'kgCO2e/unité', value: 1.1, uncertainty: 4 },
          {
            label: 'Fournitures de bureau et consommables (€)',
            type: 'Équipement de bureau',
            unit: 'kgCO2e/€ de dépense',
            value: 0.917,
            uncertainty: 1,
          },
          { label: 'Papier (ramette)', type: 'Équipement de bureau', unit: 'kgCO2e/unité', value: 2.29, uncertainty: 2 },
        ],
      },
      {
        id: 12,
      ...
      },
      {
        ...
        emissionFactors: [
          { label: 'Ballon de basket', type: 'Équipement sportif', unit: 'kgCO2e/unité', value: 4.6, uncertainty: 3 },
          { label: 'Ballon de football', type: 'Équipement sportif', unit: 'kgCO2e/unité', value: 4.12, uncertainty: 3 },
          { label: 'Ballon de volley', type: 'Équipement sportif', unit: 'kgCO2e/unité', value: 2.25, uncertainty: 3 },
          { label: 'Ballon de handball', type: 'Équipement sportif', unit: 'kgCO2e/unité', value: 2.5, uncertainty: 3 },
        ],
      },
    ],
  },
    ...
    emissionSubCategories: [
      {
        ...
        emissionFactors: [
          ...
          { label: 'Parking (béton)', type: 'Construction', unit: 'kgCO2e/m²', value: 319000, uncertainty: 2 },
          { label: 'Parking (asphalte)', type: 'Construction', unit: 'kgCO2e/m²', value: 73000, uncertainty: 2 },
          {
      ...
      },
      {
        ...
        emissionFactors: [
          { label: 'Ordinateur de bureau', type: 'Équipement', unit: 'kgCO2e/unité', value: 169000, uncertainty: 4 },
          { label: 'Tablettes', type: 'Équipement', unit: 'kgCO2e/unité', value: 63200, uncertainty: 4 },
          { label: 'Photocopieurs', type: 'Équipement', unit: 'kgCO2e/unité', value: 2935000, uncertainty: 4 },
          { label: 'Vidéoprojecteur', type: 'Équipement', unit: 'kgCO2e/unité', value: 94000, uncertainty: 5 },
          { label: 'Imprimante', type: 'Équipement', unit: 'kgCO2e/unité', value: 87900, uncertainty: 4 },
        ],
      },
    ],
  },
  {
    ...
    emissionSubCategories: [
      ...
      },
      {
        ...
        emissionFactors: [
          { label: 'January', type: 'Electricity', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'February', type: 'Electricity', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'March', type: 'Electricity', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'April', type: 'Electricity', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'May', type: 'Electricity', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'June', type: 'Electricity', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'July', type: 'Electricity', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'August', type: 'Electricity', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'September', type: 'Electricity', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'October', type: 'Electricity', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'November', type: 'Electricity', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },
          { label: 'December', type: 'Electricity', unit: 'kgCO2e/kWh', value: 0.233, uncertainty: 0 },],
      },
      {
        id: 18,
